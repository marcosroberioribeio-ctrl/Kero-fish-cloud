...
# -----------------------------------------------------------------------------
# Bootstrap e identidade visual da V12.1 de teste
# -----------------------------------------------------------------------------
...
ui.PREMIUM_CSS = f"""
<style>
:root{{--navy:#031426;--navy2:#061e38;--gold:#f1b92f}}
...
[data-testid="stSidebar"] [role="radiogroup"] label{{padding:6px 8px;border-radius:8px;margin:0;color:#edf6ff;font-size:13px}}
